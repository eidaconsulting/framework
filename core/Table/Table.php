...
class Table
{
    ...
    /**
     * Table constructor. Selectionne la table correspondant à la classe en prenant le nom de la classe sans le Table de la fin en ajoutant le prefixe af et un s à la fin
